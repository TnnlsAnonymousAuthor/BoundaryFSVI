...
def metric(dir_name):
    ...
    print("{:20}{:13.2f}%".format("TNR at TPR 95%:",(1-fprBase)*100))
    aurocBase = auroc(dir_name)
    print("{:20}{:13.2f}%".format("AUROC:",aurocBase*100))
    errorBase = detection(dir_name)
    print("{:20}{:13.2f}%".format("Detection acc:",(1-errorBase)*100))
    auprinBase = auprIn(dir_name)
    print("{:20}{:13.2f}%".format("AUPR In:",auprinBase*100))
    auproutBase = auprOut(dir_name)
    print("{:20}{:13.2f}%".format("AUPR Out:",auproutBase*100))
